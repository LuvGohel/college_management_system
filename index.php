  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        ...
        <h2>
          About us <br>
        </h2>In the year 1961, the Management of Institute was taken by Maitri Mandal and Institute was known as
        Gandhidham Civil Engineering Institute.Offering three year diploma course in civil engineering, this was under
        the guidance and leader ship of founder principal Late Shri Hari Daryani. The course was very much successful at
        that time when township of Gandhidham and Adipur were under construction.

        Over and above his success as a civil engineer and good administrator, Late Shri Hari Daryani was a highly
        optimistic and sensitive poet and had a strong sensitivity for human emotions. He felt the need of centre of
        excellence of technical education in the backward district of Kachchh, which can serve as beacon light for the
        peoples not only this district but of whole of Gujarat state. He conceived plan for full fledged diploma level
        <p>
  ...
  <div>
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <h2>Achivements </h2>
          <p>To Develop skilled, creative and socially sensitive engineers to satisfy the needs of a changing society.
          </p>
          ...
          <div class="card">
            ...
            <div class="card-body pt-5 mt-4">
              ...
              <p><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i
                  class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i></p>
              <p class="card-text">
                <b>courses</b>5<br>
                <b>rating</b>
              </p>
        ...
        <div class="col-6">
          <div class="border rounded position-relative">
            <div class="p-4 text-center ">
              ...
              Let us put all our efforts together to educate the students in a manner that we can produce self motivated
              and ethics bound young talents who can make their lives innovative by avoiding routine spoon-feeding. In
              this competitive world, let us go for the approach that is not only self or money oriented but it may
              helpful to all mankind. By doing this we can provide strength to the hands of our Principal and
              Institution.
        ...
        <div class="col-6">
          <div class="border rounded position-relative">
            <div class="p-4 text-center ">
              ...
              Goals and Objectives->To enhance the learning skills of the students to improve their technical and soft
              skills.
              To enhance self learning skills in students.
              To be in G.T.U Top 10 diploma engineering college.History of the institute dates back to early fifties. It
              was initially started as as a vocational training institute offering six months Mistry Course and 1 year
              Sub Overseer course. The institute was then managed by SRC Ltd under social.
